...
public class controller {
	...
	{  
		...
		List<Categories> allCat = catServ.getAllActiveCat();
	...
	public String butterflies(Model m, @RequestParam String category)
	{
		List<Categories> Categories  = catServ.getAllActiveCat();
